...
const FlashCardsPage = ({ term }: Props) => {
   ...
   const [widthProgress, setWidthProgress] = useState<number>(
      term.currentIndexFlashcard / term.flashcards.length || 0
   );
   ...
   return (
      ...
      >
         ...
         >
            <div className="flex items-center justify-center space-y-4 md:space-y-0 md:space-x-4 md:flex-row flex-col-reverse mb-4">
               ...
               <Button
                  ...
                  onClick={() => {
                     if (swiperRef.current) {
                        ...
                        setWidthProgress(
                           (term.flashcards.length - 1) / term.flashcards.length
                        );
                     }
                  }}
               >
         ...
         >
            <div className="md:aspect-w-5 md:aspect-h-2 mb-4 aspect-w-1 aspect-h-[1.2] ">
               <div>
                  <SwiperReact
                     className="h-full"
                     ...
                     onSlideChange={(swiper) => {
                        if (swiper.realIndex === term.flashcards.length - 1) {
                           //@ts-ignore
                           navigationNextRef.current.disabled = false;
                        }
                     }}
