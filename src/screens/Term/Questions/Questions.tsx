...
const Questions = ({ questions, termId }: Props) => {
   ...
   return (
      ...
      >
         ...
         >
            <SwiperReact
               className="md:h-[29.25rem] max-w-[52.5rem]"
               spaceBetween={16}
         ...
         <div
            className="h-header bg-white border-t border-[#edeff4] fixed left-0 bottom-[-100%] right-0 shadow-card transition-all flex items-center justify-center z-10"
            style={{
